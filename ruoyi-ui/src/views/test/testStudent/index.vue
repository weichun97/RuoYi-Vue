  ...
  methods: {
    ...
    getList() {
      ...
      if (null != this.daterangeStudentBirthday && '' != this.daterangeStudentBirthday) {
        this.queryParams["beginStudentBirthday"] = this.daterangeStudentBirthday[0];
        this.queryParams["endStudentBirthday"] = this.daterangeStudentBirthday[1];
      }
      else {
        this.queryParams["beginStudentBirthday"] = null;
        this.queryParams["endStudentBirthday"] = null;
      }
